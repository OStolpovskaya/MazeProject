...
public class Global extends GlobalSettings {
    ...
    public void onStart(play.Application app) {
        ...
        action = new Action(MapObjectType.CAVE_ENTRANCE, 30, "goTo"); action.save();
        action = new Action(MapObjectType.CAVE_EXIT, 30, "goTo"); action.save();
        action = new Action(MapObjectType.HOUSE_ENTRANCE, 10, "goTo"); action.save();
        action = new Action(MapObjectType.HOUSE_EXIT, 10, "goTo"); action.save();
